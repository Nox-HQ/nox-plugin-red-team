...
- chore(deps): Go 1.26.5 and nox SDK v1.17.0 (#33)
- chore(security): nox remediation (deps + actions) (#32)
- ci: add nox-remediate caller (deps + action-pin remediation)
- ci: point the registry notice at where entries actually go (#31)
- ci: add nox self-scan and changed-files PR gate (#30)
